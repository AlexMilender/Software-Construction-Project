...
/*
CREATE USER 'etendersadmin'@'localhost' IDENTIFIED BY 'i@hrX!48Ya6C9Zx%BpVRYBG&Q';
GRANT ALL PRIVILEGES ON *.* TO 'etendersadmin'@'localhost'
WITH GRANT OPTION;

CREATE USER 'etendersadmin'@'%' IDENTIFIED BY 'i@hrX!48Ya6C9Zx%BpVRYBG&Q';
GRANT ALL PRIVILEGES ON *.* TO 'etendersadmin'@'%'
WITH GRANT OPTION;*/